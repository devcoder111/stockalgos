    ...
    return (
        <PopUp className='__stripe-payment-popup' close={props.close}>
            <form onSubmit={handleSubmit}>
                ...
                <div className='__grey-text __mt-s __mb-15'>Enter your credit card information</div>
                <label>
                ...
                <label className='__mt-15 __block'>
                    ...
                    <input type='text' className='__input __input-field-small' placeholder='Name' />
                </label>
                ...
                <button type="submit" className='__btn __ml-a __mr-a __stripe-btn' disabled={!stripe}>Add Payment</button>
            </form>
        </PopUp>
    );
};
