  ...
  render(){
    ...
    return (
      <App setLogin={(logIn)=>this.setLogin(logIn)}>
        <BrowserRouter>
          <Switch>
            <LoginRoute exact {...this.state} path='/' component={Login} setLogin={(value)=>this.setLogin(value)}/>
            <LoginRoute exact {...this.state} path='/login' component={Login} setLogin={(value)=>this.setLogin(value)}/>
